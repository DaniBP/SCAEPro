	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == getConfigurarScaeProView().getBtnNuevoTurno()){
			...
			if(JOptionPane.showConfirmDialog(
					null, "Desea guardar los cambios realizados", "ConfirmaciÛn",JOptionPane.YES_NO_OPTION)
			...
			if(resultado.equals("correcto")){
				...
				JOptionPane.showMessageDialog(null, resultado, "AtenciÛn", JOptionPane.WARNING_MESSAGE);
			}
		}else if(e.getSource()==getConfigurarScaeProView().getBtnEliminar()){
			if(JOptionPane.showConfirmDialog(
					null, "øSeguro que desea eliminar este turno?", "ConfirmaciÛn",JOptionPane.YES_NO_OPTION)
					!=JOptionPane.YES_OPTION){
				return;
			}
